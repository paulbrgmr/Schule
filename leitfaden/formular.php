...
<div class="container">
    ...
    <input id="Vorname" type="text" placeholder="Vorname" name="Vorname">');
        ...
        <h3>Client- vs. Serverseitige Formularprüfung</h3>
        <p>Es wird empfohlen bei jedem Formular eine Prüfung einzubauen, ob die notwendigen Fehler auch korrekt ausgefüllt wurden.</p>
        <p>Hierbei gibt es zwei Methoden: die Clientseitige und die Serverseitige Prüfung.</p>
        <p>Die Clientseitige Prüfung ist einfacher umzusetzen, jedoch Fehleranfälliger. Um ein Formularelement als benötigt zu kennzeichnen, kann das Attribut <code>required</code> im <code>&lt;input&gt;</code> verwendet werden.</p>
        <p>Von dieser Verwendung ist inzwischen jedoch abzuraten da Safari mit dieser Angabe nicht umgehen kann. Alternativ kann man die Prüfung mit JavaScript durchführen. Es kann jedoch sein, dass der Client JavaScript im Browser deaktiviert hat und somit keine Prüfung möglich wäre.</p>
